...
Python - об'єктно-орієнтована мова програмування. Об'єктами являються всі типи, окрім примітивних  
Функції в Python також являються об'єктами  
Всі об'єкти можуть бути передані як аргумент та повернені функціями (включаючи інші функції)
